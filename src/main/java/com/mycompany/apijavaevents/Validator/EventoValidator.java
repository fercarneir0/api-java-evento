...
public class EventoValidator {
    ...
    public static void validarEvento(Evento evento) {
        ...
        if (evento.getCpfResponsavel() == null || !evento.getCpfResponsavel().matches("\\d{3}\\.\\d{3}\\.\\d{3}-\\d{2}")) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Erro ao processar as datas do evento. Verifique o formato.", e);
        }
    }
}
